...
const cards: Card[] = [
  {
    ...
    lines: [
      ...
      { text: '', cls: '', indent: 0 },
      { text: '// => { "result": true, "ms": 3 }', cls: 'comment', indent: 0 },
    ],
  },
  {
    label: 'Source',
    ...
    lines: [
      ...
      { text: '', cls: '', indent: 0 },
      { text: '{ "source":  "Module Pricing.', cls: 'punc', indent: 0 },
      { text: ' Rule approve given order:', cls: 'val', indent: 1 },
      { text: '   order.total < 1000",', cls: 'val', indent: 1 },
      { text: '"context": { "total": 200 } }', cls: 'key', indent: 0 },
      { text: '', cls: '', indent: 0 },
