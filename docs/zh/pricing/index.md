...
::: tip 价格
自助团队请直接看 Cloud 的 Free 与 Pro 公开定价:**[aster-lang.cloud/pricing](https://aster-lang.cloud/pricing)**。企业版(自托管)价格取决于租户规模、评估量与数据驻留要求 — 请**[联系销售](mailto:hello@aster-lang.dev)**获取报价。
:::
...
| **如何开始** | `npm i @aster-cloud/aster-lang-ts` | [aster-lang.cloud](https://aster-lang.cloud) | [联系销售](mailto:hello@aster-lang.dev) |
...
→ [**前往 aster-lang.cloud →**](https://aster-lang.cloud)
...
→ [企业版概览](/enterprise/)
→ [联系我们](mailto:hello@aster-lang.dev)
...
**有评估 / POC 许可吗？**
企业版通常提供 30 天评估窗口，并附工程支持。请[发邮件给我们](mailto:hello@aster-lang.dev)说明用例。

**价格呢？**
[联系我们](mailto:hello@aster-lang.dev)——根据评估量、租户数与驻留要求报价。开源版在 Apache-2.0 下永久免费。

---

[**前往 aster-lang.cloud →**](https://aster-lang.cloud) &nbsp; · &nbsp; [联系销售](mailto:hello@aster-lang.dev)
