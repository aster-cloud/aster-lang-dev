...
|---|:---:|:---:|:---:|
| 您的代码归您所有 | ✅ Apache-2.0 | ✅ | ✅ |
| 数据处理协议（DPA） | n/a | [公开模板](/community/compliance/dpa-template) | 定制 |
| DSAR / 数据被遗忘权 | n/a | ✅ | ✅ |
| 遥测透明度 | [文档](/community/compliance/telemetry-fields) | [文档](/community/compliance/telemetry-fields) | [文档](/community/compliance/telemetry-fields) + 客户可控开关 |
...
→ [5 分钟快速开始](https://aster-lang.cloud/zh/docs/getting-started/quickstart)
