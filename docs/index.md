...
hero:
  ...
  tagline: "Write business rules in your native language. AI drafts, humans approve, GraalVM executes. Hash-chained audit included."
  # Wording mirrors aster-lang.cloud hero (messages/en.json `hero.*`).
